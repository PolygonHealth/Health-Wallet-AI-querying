...
def create_fhir_tools(db: AsyncSession, patient_id: str) -> list:
    ...
    async def get_patient_overview() -> str:
        ...
        """
        result, _ = await executor.execute("get_patient_overview", {})
        return result
    ...
    async def execute_sql(
        ...
        result, _ = await executor.execute("execute_sql", {"sql": sql})
        return result
    ...
    async def get_fhir_resources_schema_info() -> str:
        ...
        result, _ = await executor.execute("get_fhir_resources_schema_info", {})
        return result
