...
exports.CLASSIFY_PROMPT = exports.BUDGET_EXCEEDED_PROMPT = exports.SYSTEM_PROMPT = void 0;
exports.SYSTEM_PROMPT = `You are a helpful AI assistant that answers patient questions about their health records using FHIR data. You have access to tools that can query the patient's FHIR resources.
...
exports.BUDGET_EXCEEDED_PROMPT = `You've reached the context budget limit. Please provide a final answer based on the data you've gathered so far. If you don't have enough information, acknowledge this limitation.`;
exports.CLASSIFY_PROMPT = `You classify whether a patient's message (possibly in a conversation) is a relevant FHIR related question, irrelevant, or needs clarification.
